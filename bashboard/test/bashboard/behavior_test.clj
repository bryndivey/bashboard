...
(deftest test-append-value-transform
  (is (= (append-value-transform [1] {msg/type :append-value msg/topic [:sites] :value 2})
         [1 2])
      (= (append-value-transform nil {msg/type :append-value msg/topic [:sites] :value 2})
         [2])))
